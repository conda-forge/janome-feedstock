...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/janome-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11490&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/janome-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `janome` can be installed with:

```
conda install janome
```

It is possible to list all of the versions of `janome` available on your platform with:
